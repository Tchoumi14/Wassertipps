...
class HaerteGridViewHolder(itemView: View, private val listener: TippsHaerteFragment.OnFragmentInteractionListener?) : RecyclerView.ViewHolder(itemView) {
    ...
    fun updateHolder(text: String, image: Int, color: Int){
        ...
        cardView.setOnClickListener {
                Handler().postDelayed(Runnable { listener!!.generateHaerteTipps(text) }, 300)
            }
