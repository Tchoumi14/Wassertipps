...
class TippsNitratAdapter (private val context: Context, private val listener: TippsNitratFragment.OnFragmentInteractionListener?, private val dataSource: Array<String>, private val imgSource: ArrayList<Int>, private val colorSource: Array<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        boxCard.setOnClickListener {
            Handler().postDelayed(Runnable { listener!!.generateNitratTipps(getItem(position)) }, 500)
          }
