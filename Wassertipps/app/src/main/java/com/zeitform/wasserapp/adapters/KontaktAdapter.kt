...
import com.zeitform.wasserapp.navfragments.KontaktFragment
import com.zeitform.wasserapp.navfragments.WasserinfoFragment

class KontaktAdapter (private val context: Context, private val listener: KontaktFragment.OnFragmentInteractionListener?, private val dataSource: Array<String>, private val icon:Drawable?) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        listContainer.setOnClickListener { listener!!.generateKontaktSubPage(item) }
