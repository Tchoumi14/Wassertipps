...
class ListAdapter (private val context: Context, private val listener: WasserinfoFragment.OnFragmentInteractionListener?, private val dataSource: Array<String>, private val icon:Drawable?) : BaseAdapter() {
